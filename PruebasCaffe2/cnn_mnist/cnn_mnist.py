...
#precision, sirve para llevar un seguimiento de nuestro modelo
def AddAccuracy(model, softmax, label):
	"""Adds an accuracy op to the model"""
	accuracy = brew.accuracy(model, [softmax, label], "accuracy")
	return accuracy

#aniade los operadores para entrenar nuestra red
...
#los datos para este ejemplo estan en NCHW
...
#Estructura de la red volcada a ficheros
'''
